...
import (
	...
	"github.com/tektoncd/experimental/triggers/interceptors/github/pkg/github/bindings"
	pb "github.com/tektoncd/experimental/triggers/interceptors/github/pkg/proto/v1alpha1/config_go_proto"
	...
	if prCfg.GetComment() != nil {
		return &v1alpha1.InterceptorResponse{
			...
			Status: v1alpha1.Status{
				...
				Message: "waiting for authorized approval",
			},
		}, nil
	}
